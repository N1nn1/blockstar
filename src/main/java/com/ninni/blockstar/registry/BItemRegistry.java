...
public class BItemRegistry {
    ...
    public static final RegistryObject<Item> COMPOSING_TABLE = DEF_REG.register("composing_table", () -> new BlockItem(BBlockRegistry.COMPOSING_TABLE.get(), new Item.Properties()));
